...
import com.example.khang.binhduongemergency.AutoFitTextureView;
...
//        }
    ...
    private String getVideoFilePath(Context context) {
        ...
        String mediaFile = mediaStorageDir.getPath() + File.separator + "VID_" + timeStamp + ".mp4";
        return mediaFile;
    }
    ...
    private void stopRecordingVideo() {
        ...
        if (null != activity) {
            ...
            PhanAnhActivity.urlDataList.add(new URLData(mNextVideoAbsolutePath,"VID"));
            PhanAnhActivity.videoPath = mNextVideoAbsolutePath;
        }
